...
// If I'm not mistaken covariance is like the "noise" of the signal.
// Kalman gain is just something we make up based on old data to basically
// "guess" what the actual signal is supposed to be.
